...
function ejecutar_crossvalidation(input,target,arquitectura)
...
error_data=ejecutar_crossvalidation(input,target,1)
error_data=hcat(error_data,ejecutar_crossvalidation(input,target,2))
error_data=hcat(error_data,ejecutar_crossvalidation(input,target,3))
error_data=hcat(error_data,ejecutar_crossvalidation(input,target,4))
gr();
